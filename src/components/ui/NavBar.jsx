...
export default function NavBar({ sectionRefs }) {
  ...
  return (
    <header
      ref={navBar}
      className="fixed top-0 z-50 flex w-full -translate-y-full items-center justify-between bg-secondary-100 px-5 py-5">
      {/* logo */}
      <a href="#hero" aria-label="Logo" className="z-50 text-xl font-bold font-grotesk">
        SAM
      </a>
