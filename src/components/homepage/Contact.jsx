...
export default function Contact() {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_2r3y74b', 'template_zqstuoy', form.current, 'LtSTcgu8YR0pQj7eq')
      .then((result) => {
      ...
      <div ref={contactSection} className="mt-10 flex flex-col gap-20 md:grid md:grid-cols-6 md:px-12">
        <div className="col-span-4">
          <h3 ref={heading} className="max-w-lg 2xl:max-w-3xl text-heading-3 2xl:text-7xl font-semibold leading-tight translate-y-10 opacity-0">
           Get in Touch?<br /> Let&apos;s bring it to life.
          </h3>
        ...
        <div className="col-span-2 grid grid-cols-1 gap-x-4 gap-y-8 text-accent-300 sm:grid-cols-2 sm:gap-y-0 md:grid-cols-1">
          <div className="space-y-3 ">
            ...
            <div className="flex flex-col space-y-3 text-body-2 2xl:text-3xl">
              <a
                href="mailto:samishaikh05687@gmail.com"
                className="group relative w-fit cursor-pointer"
                target="_blank"
                rel="noreferrer"
              >
                <span>Samishaikh05687@gmail.com</span>
                <span className="absolute bottom-0 left-0 h-[0.12em] w-0 rounded-full bg-secondary-600 duration-300 ease-in-out group-hover:w-full"></span>
              </a>
              <a className="group relative w-fit cursor-pointer" href="tel:9827253217">
                <span>+91 9827253217</span>
                <span className="absolute bottom-0 left-0 h-[0.12em] w-0 rounded-full bg-secondary-600 duration-300 ease-in-out group-hover:w-full"></span>
                </a>
            </div>
          </div>
          <div className="space-y-3 ">
            ...
            <div className="space-y-3 text-body-2 2xl:text-3xl">
              ...
              <a
                href="https://github.com/Samishaikh05687"
              ...
              <a
                href="https://www.linkedin.com/in/sami-shaikh-952747217/"
